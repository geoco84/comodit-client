...
cp /var/lib/mock/fedora-16-i386/result/${NAME}-${VERSION}-${RELEASE}*.noarch.rpm /var/www/html/public/comodit-dev/fedora/16/i686/
cp /var/lib/mock/fedora-16-i386/result/${NAME}-${VERSION}-${RELEASE}*.noarch.rpm /var/www/html/public/comodit-dev/fedora/16/x86_64/
cp /var/lib/mock/fedora-16-i386/result/${NAME}-${VERSION}-${RELEASE}*.src.rpm /var/www/html/public/comodit-dev/fedora/16/SRPMS/
