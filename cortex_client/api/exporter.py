...
class Export(object):
    ...
    def _export_resource(self, res, res_folder, export_files = False, export_thumb = False):
    ...
    def export_distribution(self, dist, dist_folder):
        self._export_resource(dist, dist_folder, True, True)

    def export_platform(self, plat, plat_folder):
        self._export_resource(plat, plat_folder, True)
